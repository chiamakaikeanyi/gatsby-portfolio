...
const config = {
  ...
  siteOgType: 'website',
  author: 'Chiamaka Ikeanyi',
  authorProfilePic: profilePic,
  twitterHandle: '@chiamakaikeanyi',
  linkedIn: 'https://www.linkedin.com/in/chiamakaikeanyi',
  github: 'https://github.com/chiamakaikeanyi',
  codepen: 'https://codepen.io/chiamakaikeanyi',
  stackoverflow: 'https://stackoverflow.com/users/7000929/chiamaka-ikeanyi',
  twitter: 'https://twitter.com/chiamakaikeanyi',
  medium: 'https://medium.com/@chiamakaikeanyi',
  imageWidth: 1200,
  imageHeight: 1200,
};
